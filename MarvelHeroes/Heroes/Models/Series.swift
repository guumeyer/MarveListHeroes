...
public class Series: NSObject {
    ...
    /**
     ...
     Sample usage:
     let series_list = Series.modelsFromDictionaryArray(someDictionaryArrayFromJSON)
     
     - parameter array:  NSArray from JSON dictionary.
     
     - returns: Array of Series Instances.
     */
    public class func modelsFromDictionaryArray(array:NSArray) -> [Series]
    {
        ...
        for item in array
        {
            models.append(Series(dictionary: item as! NSDictionary)!)
        }
        return models
    }
    ...
    /**
     ...
     Sample usage:
     let series = Series(someDictionaryFromJSON)
